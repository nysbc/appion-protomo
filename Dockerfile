...
&& wget http://emg.nysbc.org/redmine/attachments/download/10963/imod_4.10.11_docker_stripped.tar.gz && tar xzfv imod_4.10.11_docker_stripped.tar.gz -C /sw && rm imod_4.10.11_docker_stripped.tar.gz \
