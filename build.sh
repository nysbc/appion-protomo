...
wget -nc -c 'http://emg.nysbc.org/redmine/attachments/download/10553/myami-trunk-10-29-18.tar.gz'
...
tar zxvf TGZ/myami-trunk-10-29-18.tar.gz myami-trunk
docker build -t semc/appion-protomo:v1.1 .
