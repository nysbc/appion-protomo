...
wget -nc -c 'http://emg.nysbc.org/redmine/attachments/download/10624/myami-trunk-11-4-18.tar.gz'
...
tar zxvf TGZ/myami-trunk-11-4-18.tar.gz myami-trunk
docker build -t semc/appion-protomo:v1.1.1 .
