...
wget -nc -c 'http://emg.nysbc.org/redmine/attachments/download/10656/myami-trunk-11-8-18.tar.gz'
...
tar zxvf TGZ/myami-trunk-11-8-18.tar.gz myami-trunk
docker build --no-cache -t semc/appion-protomo:testing .
