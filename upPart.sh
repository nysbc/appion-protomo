...
--image-dir=/sw/myami/appion/docker/centos7/17apr12a \
--description='test'
...
imageloader.py \
  ...
  --dir=/sw/myami/appion/docker/centos7/09sep20a-Pickwei_good_CTF/ \
...
imageloader.py \
  ...
  --dir=/sw/myami/appion/docker/centos7/13aug08set9/ --filetype=mrc \
