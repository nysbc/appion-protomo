...
if [ -d "/var/lib/mysql/mysql" ]; then
	...
	do
	  ...
	  sleep 5
        ...
        mysql -u root < /emg/sw/sql/leginondb.sql && echo 'mysql leginondb upload' >> /var/log/startup.log
        mysql -u root < /emg/sw/sql/projectdb.sql && echo 'mysql projectdb upload' >> /var/log/startup.log
